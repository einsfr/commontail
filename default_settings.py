...
COMMONTAIL_BANNER_CACHE_LIFETIME: int = 3600

COMMONTAIL_BREADCRUMB_MAX_WORDS: int = 5
...
COMMONTAIL_NAMED_URL_CACHE_LIFETIME: int = 86400
...
COMMONTAIL_RAWHTML_BLOCK_REPLACE_SAFE_ATTRS: bool = False
COMMONTAIL_RAWHTML_BLOCK_SAFE_ATTRS: set = set()

COMMONTAIL_REMOVE_TRAILING_DOTS: bool = True
COMMONTAIL_REMOVE_MULTIPLE_SPACES: bool = True
...
COMMONTAIL_URL_API_PREFIX: str = 'api/commontail/'
COMMONTAIL_URL_API_EMBED: str = 'embed/html/'
